...
MVP-0 was done when every scorecard row passed, and it does: **animals 36 / 36 graded rows with parity, 1 reported, 0 pending; emotions 35 / 35, 2 reported, 0 pending**, on 487 tests. What comes next is the design pass ([#66](https://github.com/razrfly/dictionary/issues/66)), the evidence wall ([#67](https://github.com/razrfly/dictionary/issues/67)) and quotes ([#65](https://github.com/razrfly/dictionary/issues/65)) — none of which changes the thirteen tables.
