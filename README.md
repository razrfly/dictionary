...
| S0 reset in place & first numbers (index size, scope size) | ⬜ |
...
The app is being regenerated in place (reset procedure in #70). This README is the file to keep when running `mix phx.new`; `AGENTS.md` is regenerated by the generator. Dumps live in `data/` (ignored). After S0:
