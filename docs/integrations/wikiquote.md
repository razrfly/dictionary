...
| Endpoints | `GET https://en.wikiquote.org/api/rest_v1/page/html/<title>` (Parsoid HTML) and `wbgetentities` on `https://www.wikidata.org/w/api.php`. **Never** `action=parse` wikitext and **never** `list=search` (#158 Finding 1) |
...
|---|---|---|---|---|---|---|---|
| war | Q198 (dev registry) | War | 12, more behind | 0 | 👑 4 · 📚 4 · 📱 4 | 10 / 12 | 3 |
| power | Q911554 (dev registry: *business magnate*) | Business magnate | 3 | 0 | 👑 1 · 📚 1 · 📱 1 | 2 / 3 | 3 |
| nepotism | Q161165 (by enwiki) | Nepotism | 3 | 0 | 👑 1 · 📱 2 | 1 / 3 (Bierce) | 3 |
| grief | Q1026040 | Grief | 12, more | 0 | 👑 5 · 📚 1 · 📱 3 · undated 3 | 11 / 12 | 3 |
| love | Q316 | Love | 12, more | 0 | 👑 4 · 📚 2 · 📱 2 · undated 4 | 11 / 12 | 3 |
| family | Q8436 | Family | 12, more | 0 | 👑 3 · 📚 3 · 📱 4 · undated 2 | 10 / 12 | 3 |
| solitude | Q6010868 | Solitude | 12, more | 0 | 👑 7 · 📚 2 · 📱 2 · undated 1 | 9 / 12 | 3 |
| justice | Q13189320 | Justice | 12, more | 0 | 👑 4 · 📚 2 · 📱 1 · undated 5 | 9 / 12 | 3 |
...
would do once their senses refer to their concepts.
...
- Crosswalk: Wikidata's own sitelink, read by `wbgetentities`. Authors: the
  page a citation links to first, resolved to its QID by *its* `enwikiquote`
  sitelink — never by name. `:candidate` on a theme page; `:verified` for an
  author page's own cited work
